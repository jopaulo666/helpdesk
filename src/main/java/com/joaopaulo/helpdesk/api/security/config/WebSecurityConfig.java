package com.joaopaulo.helpdesk.api.security.config;
...
import com.joaopaulo.helpdesk.api.security.jwt.JwtAuthenticationEntryPoint;
import com.joaopaulo.helpdesk.api.security.jwt.JwtAuthenticationTokenFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	public void configureAuthentication(AuthenticationManagerBuilder managerBuilder) throws Exception {
		managerBuilder.userDetailsService(this.detailsService).passwordEncoder(passwordEncoder());
	}
